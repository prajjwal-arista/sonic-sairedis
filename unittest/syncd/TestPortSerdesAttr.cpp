...
TEST_F(TestPortSerdesAttr, SerializePortSerdesAttr)
{
...
TEST_F(TestPortSerdesAttr, DeserializePortSerdesAttr)
{
...
TEST_F(TestPortSerdesAttr, CollectDataAndValidateCountersDB)
{
    ...
    // Connect to COUNTERS_DB and verify entries in PORT_SERDES_ATTR table
    swss::RedisPipeline pipeline(&db);
    swss::Table portSerdesAttrTable(&pipeline, PORT_PHY_ATTR_TABLE, false);
    ...
    bool found = portSerdesAttrTable.hget(expectedKey, "rx_vga", rxVgaValue);
    ...
    found = portSerdesAttrTable.hget(expectedKey, "tx_fir_taps_list", txFirTapsValue);
